...
public class MainActivity<etChirps> extends AppCompatActivity {
    ...
    btnCalculate.setOnClickListener(new View.OnClickListener(){
        ...
        public void onClick (View view){
            ...
            if(etChirps.getText().toString().isEmpty())
            {
                ...
                String results = "The appropriate  temperature outside is"+formatter.format(temp)+"degrees Celsius.";
